...
>>>>>>> 5aafcfcc9d56dd6386968970f09a6c45823141fa
      ...
      <section style={{
        ...
        <ul style={{ fontSize: '28px', textAlign: 'left', margin: '0 auto', maxWidth: '800px' }}>
          <li><strong>Restarant</strong> A fine-dining restaurant offering a seasonal menu with a focus on locally sourced ingredients.</li>
          <li><strong>Bistro:</strong> A casual dining spot perfect for a quick breakfast, lunch, or evening snack, featuring a variety of global cuisines.</li>
          <li><strong>Lounge</strong> A chic, intimate space where you can enjoy handcrafted cocktails, fine wines, and a selection of premium spirits.</li>
        </ul>
        <p>
      ...
      <section style={{
        ...
        <ul style={{ fontSize: '28px', textAlign: 'left', margin: '0 auto', maxWidth: '800px' }}>
          <li><strong>[Attraction 1]:</strong> A short 20-minute walk/drive from the hotel, perfect for cultural enthusiasts.</li>
          ...
          <li><strong>[Public Transport Hub]:</strong> Convenient access to Mexico's public transport, making it easy to explore the entire city.</li>
        </ul>
      </section>
      ...
      <section style={{
        ...
        <ul style={{ fontSize: '28px', textAlign: 'left', margin: '0 auto', maxWidth: '800px' }}>
          ...
          <li><strong>[Award Name]:</strong> Voted as one of the top hotels in Mexico.</li>
          <li><strong>[Award Name]:</strong> Our Bar has received accolades for its innovative offerings.</li>
        </ul>
        <p>
      ...
      <section style={{
        ...
        <ul style={{ fontSize: '28px', textAlign: 'left', margin: '0 auto', maxWidth: '800px' }}>
          <li><strong>Phone:</strong> 03334556745</li>
          <li><strong>Email:</strong> fg@yyhvkuh.trdt</li>
          <li><strong>Address:</strong> rtcytvjhuynjn</li>
        </ul>
        <p>
          We look forward to welcoming you to Grands hotel, where your comfort and satisfaction are our highest priorities.
