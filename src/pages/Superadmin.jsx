...
const tabs = [
  ...
  { id: "access", label: "Roles & Permissions", icon: FaKey },
  { id: "inventory", label: "Hotel Inventory", icon: FaHotel },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5 mb-8">
          <div>
            <div className="inline-flex items-center gap-2 text-gold-400 text-xs uppercase tracking-[0.2em] font-semibold mb-3">
              <FaCog /> Superadmin control center
            </div>
            <h1 className="font-serif text-4xl font-bold text-white">
              Hotel operations, in one room.
            </h1>
            <p className="text-gray-400 mt-2 max-w-2xl">
              Manage access, people, inventory, and the health of the property
              without leaving the command desk.
            </p>
          </div>
          <button
            onClick={loadData}
        ...
        <div className="flex gap-2 overflow-x-auto border-b border-slate-800 mb-8 pb-px">
          {tabs.map(({ id, label, icon: Icon }) => (
            <button
              ...
              className={`inline-flex items-center gap-2 whitespace-nowrap px-4 py-3 text-sm font-semibold border-b-2 transition ${activeTab === id ? "text-gold-300 border-gold-400" : "text-gray-400 border-transparent hover:text-white"}`}
            >
              <Icon /> {label}
            </button>
          ))}
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400">Inventory coverage</span>
                    <span className="text-emerald-400">
                      {data.rooms.length
                        ? Math.round((availableRooms / data.rooms.length) * 100)
                        : 0}
                      % available
                    </span>
                  </div>
        ...
        {activeTab === "inventory" && (
          <section className="space-y-6">
            ...
            >
              <h2 className="font-serif text-xl text-white mb-4">
                <FaPlus className="inline text-gold-400 mr-2" /> Add room type
              </h2>
        ...
        {activeTab === "people" && (
          <section className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3">
                {["name", "email", "phone_number", "password"].map((field) => (
                  <input
                    ...
                    onChange={(e) =>
                      setPeopleForm({ ...peopleForm, [field]: e.target.value })
                    }
                  />
                ))}
                <select
            ...
            >
              <h2 className="font-serif text-xl text-white mb-4">
                <FaPlus className="inline text-gold-400 mr-2" /> Create a role
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                <h2 className="font-serif text-xl text-white mb-4">Managers</h2>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                <h2 className="font-serif text-xl text-white mb-4">Guests</h2>
